      ...
      <div className={`w-full transition-all lg:max-w-none lg:min-h-screen lg:bg-gray-50 ${
        ...
        <div className="flex-1 overflow-y-auto pb-24 lg:pb-8 px-5 lg:px-8 pt-4 lg:pt-8 lg:max-w-4xl lg:mx-auto lg:w-full">
          ...
          {currentView === 'home' && currentUser && (() => {
            ...
            // Same shape as the SOP division tiles: a 2:1 card on a grid whose
            // column count steps up with the viewport, icon beside the label.
            // Each tile is framed in its section's colour and filled with the
            // faintest tint of it, so the card reads as one object with the icon.
            const tile = (tone: string) =>
              `aspect-[2/1] border-2 ${tone} hover:shadow-md rounded-2xl p-3 text-left transition-all active:scale-[0.99] flex items-center gap-2.5 overflow-hidden`;
            ...
            const circle = (colour: string) =>
              `relative w-10 h-10 rounded-full ${colour} flex items-center justify-center text-white shadow-md transition-colors flex-shrink-0`;
            const label = 'block text-sm leading-tight font-black text-gray-900';
            ...
            return (
              <div className="space-y-6 py-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5">
                  <button onClick={() => setCurrentView('dashboard')} className={tile('border-emerald-800 bg-emerald-50')}>
                  ...
                  <button onClick={() => setCurrentView('handbook')} className={tile('border-blue-800 bg-blue-50')}>
                    <span className={circle('bg-blue-800 hover:bg-blue-700')}>
                  ...
                  <button onClick={() => setCurrentView('careerLadder')} className={tile('border-amber-600 bg-amber-50')}>
                    <span className={circle('bg-amber-600 hover:bg-amber-500')}>
                  ...
                  <button onClick={() => { setOpenTraining(null); setCurrentView('training'); }} className={tile('border-violet-800 bg-violet-50')}>
                    <span className={circle('bg-violet-800 hover:bg-violet-700')}>
                      <svg className={icon} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 14l9-5-9-5-9 5 9 5z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-6 4v-3.5"/></svg>
                    </span>
                    <span className="min-w-0"><span className={label}>Training</span></span>
                  </button>
                  <button onClick={() => setCurrentView('safety')} className={tile('border-red-700 bg-red-50')}>
                  ...
                  <button onClick={() => setCurrentView('userNotifications')} className={tile('border-rose-700 bg-rose-50')}>
